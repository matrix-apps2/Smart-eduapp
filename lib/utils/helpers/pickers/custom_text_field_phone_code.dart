...
//   void initState() {
//     super.initState();
//     if(widget.eygptIsInial==true){
//       widget.initialCountry= const Country(
//         name: "Egypt",
//         flag: "🇪🇬",
//         code: "EG",
//         dialCode: "20",
...
//                       child: CustomTapEffect(onTap: widget.onUpdate!, child: Icon(Icons.edit,color: Theme.of(context).primaryColor)),
...
//                     },
//                     validateFunc: (value) {
//                       print('validateFunc ${(value??'').toString().isEmpty} $value  555 ${!widget.disableLengthCheck && value != null}');
...
//           ),
//         ),
//         // if(_selectedCountry.code=='EG'&& widget.enabled==true && widget.readOnly==false)
//         // Row(
//         //   mainAxisAlignment: MainAxisAlignment.end,
//         //   children: [
//         //     Text(tr(LocaleKeys.addNumber10),style: const TextStyle().regularStyle(fontSize: 11,fontWeight: FontWeight.w300).colorBlack(),textAlign: TextAlign.end),
//         //     8.width,
//         //
//         //   ],
//         // ),
...
//       decoration: const BoxDecoration().cardStyle().borderStyle(),
...
//                   FittedBox(child: Text('+${_selectedCountry.dialCode}', style: widget.dropdownTextStyle??const TextStyle().regularStyle().colorBlack())),
