...
/// This means that at any given time, at most, one [ExpansionPanelRadioTest]
/// can remain expanded.
///
/// A unique identifier [value] must be assigned to each panel.
/// This identifier allows the [CustomExpansionPanelList] to determine
/// which [ExpansionPanelRadioTest] instance should be expanded.
///
/// See [ExpansionPanelListTest.radio] for a sample implementation.
class ExpansionPanelRadioTest extends CustomExpansionPanel {
  /// An expansion panel that allows for radio functionality.
  ///
  /// A unique [value] must be passed into the constructor. The
  /// [headerBuilder], [body], [value] must not be null.
  ExpansionPanelRadioTest({
    required this.value,
...
/// and [ExpansionPanelListTest.radio].
///
/// {@tool dartpad}
/// Here is a simple example of how to implement ExpansionPanelListTest.
///
...
class CustomExpansionPanelList extends StatefulWidget {
  ...
  /// of [ExpansionPanelRadioTest].
  ///
  /// {@tool dartpad}
  /// Here is a simple example of how to implement ExpansionPanelListTest.radio.
  ///
  ...
  const CustomExpansionPanelList.radio({
    super.key,
    this.children = const <ExpansionPanelRadioTest>[],
    this.expansionCallback,
    this.animationDuration = kThemeAnimationDuration,
  ...
  ///
  /// If ExpansionPanelListTest.radio is used, the callback may be called a
  /// second time if a different panel was previously open. The arguments
  /// passed to the second callback are the index of the panel that will close
  /// and false, marking that it will be closed.
  ///
  /// For ExpansionPanelListTest, the callback needs to setState when it's notified
  /// about the closing/opening panel. On the other hand, the callback for
  /// ExpansionPanelListTest.radio is simply meant to inform the parent widget of
  ...
  /// only used when initializing with the [ExpansionPanelListTest.radio]
  /// constructor.)
...
class _CustomExpansionPanelListState extends State<CustomExpansionPanelList> {
  ExpansionPanelRadioTest? _currentOpenPanel;
  ...
  void initState() {
    ...
    if (widget._allowOnlyOnePanelOpen) {
      assert(_allIdentifiersUnique(),
          'All ExpansionPanelRadioTest identifier values must be unique.');
      if (widget.initialOpenPanelValue != null) {
        _currentOpenPanel = searchPanelByValue(
            widget.children.cast<ExpansionPanelRadioTest>(),
  ...
  void didUpdateWidget(CustomExpansionPanelList oldWidget) {
    ...
    if (widget._allowOnlyOnePanelOpen) {
      assert(_allIdentifiersUnique(),
          'All ExpansionPanelRadioTest identifier values must be unique.');
      // If the previous widget was non-radio ExpansionPanelListTest, initialize the
  ...
  bool _allIdentifiersUnique() {
    ...
    for (final ExpansionPanelRadioTest child
        in widget.children.cast<ExpansionPanelRadioTest>()) {
  ...
  bool _isChildExpanded(int index) {
    if (widget._allowOnlyOnePanelOpen) {
      final ExpansionPanelRadioTest radioWidget =
          widget.children[index] as ExpansionPanelRadioTest;
  ...
  void _handlePressed(bool isExpanded, int index) {
    ...
    if (widget._allowOnlyOnePanelOpen) {
      final ExpansionPanelRadioTest pressedChild =
          widget.children[index] as ExpansionPanelRadioTest;

      // If another ExpansionPanelRadioTest was already open, apply its
      // expansionCallback (if any) to false, because it's closing.
      for (int childIndex = 0;
          childIndex < widget.children.length;
          childIndex += 1) {
        final ExpansionPanelRadioTest child =
            widget.children[childIndex] as ExpansionPanelRadioTest;
  ...
  ExpansionPanelRadioTest? searchPanelByValue(
      List<ExpansionPanelRadioTest> panels, Object? value) {
    for (final ExpansionPanelRadioTest panel in panels) {
